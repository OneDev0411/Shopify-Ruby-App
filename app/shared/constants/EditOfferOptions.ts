...
export const AutopilotQuantityOptionsNew = [
   '1 (recommended)',
   '2',
   '3',
'4', '5'
...
export const OFFER_DEFAULTS = {
  ...
  uses_ab_test: undefined,
  stop_showing_after_accepted: false,
  recharge_subscription_id: undefined,
  interval_unit: undefined,
  interval_frequency: undefined,
  ...
  custom_field_2_name: undefined,
  custom_field_2_placeholder: undefined,
  custom_field_2_required: undefined,
  custom_field_3_name: undefined,
  custom_field_3_placeholder: undefined,
  custom_field_3_required: undefined,
  css_options: {
    main: {
      color: "#2B3D51",
  ...
  save_as_default_setting: undefined,
  ...
  offers_limit_reached: undefined
}
